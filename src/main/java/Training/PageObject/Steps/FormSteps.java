...
public class FormSteps {
     ...
     * Шаг : Получаем id гендеров
     * Шаг : Добавляем в список id
     * Шаг : Получаем id гендера по индексу
    ...
    /*
     * Шаг : в xPath подставляется id чекбокса
     * Шаг : Клик по SelenideElement
     * ОР : Выбран чекбокс
     */
    @Step("Выбрать гендер")
    ...
    /*
     * Шаг : Клик по "год"
     * Шаг : выбрать 1 значение из списка
